...
export const mockVideoIntelligence = {
    ...
    results: {
        ...
        delivery_strength: 90,
        visual_quality: 82,
        editing_quality: 78,
        emotional_impact: 85,
        content_uniqueness: 72,
        competitor_benchmark: 80,
        competitor_benchmark_text: "Your video pacing is slower than top creators. Information depth similar. Visual quality slightly lower.",
        safety_score: 100,
        virality_score: 86,
        virality_prediction: "High Viral Potential",
        ai_improvements: [
            "Increase hook strength in first 3 seconds",
            "Add more scene transitions",
            "Reduce repetitive explanations in Scene 5",
            "Improve lighting in the final shot to match the intro"
        ]
    },
    recommendations: [
...
export const mockDistributionPlan = {
    ...
    results: {
        youtube: {
            content: "Discover the 5 free AI tools I use daily to automate my entire workflow — from note-taking to video editing! 🚀\n\nWe all waste hours doing boring admin tasks instead of focusing on what matters. These completely free AI assistants have helped me replace $2,000/mo in virtual assistant work.\n\n⏰ Timestamps:\n0:00 Intro\n0:18 Tool #1: Notion AI - Auto-organizing notes\n1:02 Tool #2: Gamma - 1-click presentations\n1:45 Tool #3: Perplexity - Deep research engine\n2:30 Tool #4: Descript - Video editing by text\n3:15 Tool #5: Zapier Central - AI workflow automation\n3:50 Final Thoughts\n\n🔗 Sources & Links mentioned:\n- https://notion.so\n- https://gamma.app\n\nWhich tool are you going to try first? Let me know below!",
            hashtags: ["#AITools", "#Productivity", "#FreeAI", "#Automation", "#WorkSmarter", "#CreatorTools", "#2025Tech"]
        },
        shorts: {
            content: "Stop washing time on admin tasks! 🛑 Here are 5 strictly FREE AI tools that replaced my entire virtual assistant.\n\nFirst is Notion AI to organize absolutely everything. Then Gamma to make slides in seconds instead of hours... ⏱️\n\nTap the link in my channel for the full tutorial and all tool links!\n\n🔗 Links: https://notion.so, https://gamma.app",
            hashtags: ["#shorts", "#aitools", "#productivity", "#tech"]
        },
        instagram: {
            content: "I fired my virtual assistant and hired these 5 AI tools instead 🤖✨\n\nAll completely free. All game-changing for your daily workflow.\n\nHere’s the lineup:\n1️⃣ Notion AI\n2️⃣ Gamma\n3️⃣ Perplexity\n4️⃣ Descript\n5️⃣ Zapier Central\n\nSave this post for later so you remember to install them! 📌 Which is your favorite?",
            hashtags: ["#AItools", "#productivitytips", "#techlife", "#worksmarter", "#AI2025", "#freetools", "#contentcreator", "#automate", "#smallbusiness"]
        },
        x: {
            content: "I save 15+ hours a week using completely FREE AI tools instead of a virtual assistant. 🤯\n\nNotion AI for notes, Gamma for slides, and Perplexity for research.\n\nStop wasting time on admin work. 🛑 👇",
            hashtags: ["#AITools", "#Productivity", "#Tech"]
        },
        facebook: {
            content: "We're all trying to get more done in less time, right? 😅\n\nI just put together a quick breakdown of the 5 free AI tools that have literally replaced my need for a virtual assistant. They handle writing, organizing, and even video editing for me automatically.\n\nI’m curious — has anyone here started using AI for their daily tasks yet? What's your favorite tool so far? Let's discuss in the comments!",
            hashtags: ["#ProductivityHacks", "#AIforBusiness", "#WorkSmarter", "#TechTools"]
        }
    },
    recommendations: [
        "Post YouTube first, then repurpose clips to Instagram and YouTube Shorts within 2 hours",
        "Use X (Twitter) thread features if expanding on each tool",
        "Engage with comments on Facebook within the first hour to boost algorithm reach"
    ]
};
